...
class BarcodeGeneratorHTML extends BarcodeGenerator
{
     ...
     * @public
     */
    public function getBarcode($code, $type, $widthFactor = 2, $totalHeight = 30, $color = 'black', $margin = 'inherit')
    {
        $barcodeData = $this->getBarcodeData($code, $type);

        $html = '<div style="margin:'.$margin.';font-size:0;position:relative;width:' . ($barcodeData['maxWidth'] * $widthFactor) . 'px;height:' . ($totalHeight) . 'px;">' . "\n";
